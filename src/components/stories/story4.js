...
const TypeRacer = () => {
    ...
    const paragraphs = useMemo(() => [
        "In a quaint village nestled between rolling hills, there lived a curious boy named Oliver and his faithful cat, Whiskers. One bright afternoon, they embarked on a whimsical journey to discover the secrets of the old, mysterious forest nearby. As they meandered through towering trees and moss-covered paths, they stumbled upon a hidden glade filled with sparkling fireflies. Together, Oliver and Whiskers danced under the twinkling lights, their laughter echoing through the tranquil forest. With hearts full of wonder, they returned home, their bond stronger than ever, eager for the next adventure awaiting them in the enchanting woods."
    ], []); 
