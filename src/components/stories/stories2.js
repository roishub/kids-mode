...
const TypeRacer = () => {
    ...
    const paragraphs = useMemo(() => [
        "Once upon a time, in a galaxy far, far away, there lived two curious friends, Luna the brave astronaut and Cosmo the clever robot, who embarked on a thrilling adventure exploring outer space in their trusty rocket ship, the Star Voyager, encountering a dazzling array of planets, navigating asteroid fields, and making friends with alien creatures, learning valuable lessons about teamwork and friendship along the way."
    ], []); 
