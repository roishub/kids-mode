...
const TypeRacer = () => {
    ...
    const paragraphs = useMemo(() => [
        "In a cozy forest glade, Felix, a mischievous fox, met Sammy, a friendly squirrel. Felix proposed a game of hide-and-seek, eager to showcase his cunning skills. As the sun dipped below the horizon, Felix found Sammy nestled in a hollow tree, giggling with delight. With a playful wink, Felix declared Sammy the winner, their friendship sealed in the twilight's gentle embrace."
    ], []); 
    ...
    const loadParagraph = useCallback(() => {
        ...
        setMistakes(0);
        setIsTyping(false);
        setTimeLeft(120); // Reset timeLeft to its initial value
