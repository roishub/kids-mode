...
const TypeRacer = () => {
    ...
    const paragraphs = useMemo(() => [
        "In a lush jungle, a family of monkeys lived harmoniously among the branches. Led by wise elder monkey, Maya, they thrived, living in peace with their surroundings. Every day, Maya taught the young monkeys the importance of sharing and cooperation, showing them how working together made their lives richer. One day, a new monkey named Leo joined their family. Leo was selfish and refused to share, despite Maya's efforts to teach him kindness. In a sudden storm, Leo found himself stranded, and the other monkeys rushed to his aid, forming a chain to help him to safety. Realizing the importance of support and kindness, Leo transformed, embracing sharing and cooperation. The story taught the monkeys the power of kindness and the importance of unity."
    ], []); 
